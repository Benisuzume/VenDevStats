...
<div id="footer">
    ...
    <div class="container">
	<?php os_footer();?>
	<div class="credit">Copyright &#169; <?=date("Y")?> &#183; Powered by <a target="_blank" href="https://vendev.info/">DevStats <?=OS_VERSION?></a> modified by <a target="_blank" href="https://vendev.info/">Venmade</a></div>
	<?=show_debug( $_debug  )?>
	<?php os_after_footer(); ?>
